...
Write-Host "OPSIQO V7.4 validates the signed dependency baseline and build-safe client boundaries." -ForegroundColor Yellow
...
Write-Host "`nOPSIQO 8.5 V7.4 validation gates completed successfully." -ForegroundColor Green
