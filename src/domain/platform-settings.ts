...
export interface PlatformSettings{id:'platform';registrationMode:RegistrationMode;guestAccessEnabled:boolean;guestReadOnly:boolean;allowPasswordSignIn:boolean;allowSelfPasswordReset:boolean;sessionTimeoutMinutes:number;mfaPolicy:MfaPolicy;defaultLocale:LocaleCode;defaultTimezone:string;dateFormat:DateFormat;weekStartsOn:WeekStart;defaultTheme:DefaultTheme;defaultDensity:DefaultDensity;allowUserAppearanceOverride:boolean;documentCompanyName:string;documentLegalName:string;documentLogoUrl:string;documentPrimaryColor:string;documentAccentColor:string;documentAddress:string;documentPhone:string;documentEmail:string;documentWebsite:string;documentFooter:string;updatedAt:string;updatedBy:string}
