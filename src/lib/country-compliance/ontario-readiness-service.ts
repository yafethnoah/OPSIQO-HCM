...
export async function saveOntarioComplianceProfile(actor: ActorContext, raw: unknown) {
  ...
  const after: OntarioComplianceProfile = {
    ...
    ontarioEmployeesOnJan1: nonNegativeNumber(input.ontarioEmployeesOnJan1, 'January 1 Ontario employee count'),
    jan1EmployeeCountReviewed: bool(input.jan1EmployeeCountReviewed),
    ...
    jobPostingCompensationRef: text(input.jobPostingCompensationRef),
    jobPostingAiDisclosureRef: text(input.jobPostingAiDisclosureRef),
    jobPostingVacancyRef: text(input.jobPostingVacancyRef),
    jobPostingCanadianExperienceRef: text(input.jobPostingCanadianExperienceRef),
    interviewStatusProcedureRef: text(input.interviewStatusProcedureRef),
    jobPostingRetentionRef: text(input.jobPostingRetentionRef),
