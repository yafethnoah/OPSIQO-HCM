...
export async function parseResumeIntake(actor: ActorContext, form: FormData) {
  if (!(actor.permissions.includes('recruiting.manage' as any) || actor.permissions.includes('recruiting.manage.team' as any))) throw new ApiError(403, 'Recruiting management permission required.', 'forbidden');
