...
const RESUME_PROMPT_VERSION='RECRUITING_RESUME_PARSE_V13_SEMANTIC_ENTITY_PURITY_READINESS';
...
export async function governedStructuredResumeRepair(
 ...
 const prompt=[
   ...
   'Merge duplicate partial and complete records. Remove heading/narrative/action-sentence contamination. Canonicalize duplicate volunteer organizations to the shortest source-grounded organization name. Separate education location from status and recover wrapped expected graduation dates.',
