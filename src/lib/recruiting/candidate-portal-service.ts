...
const employment=z.object({id:z.string().optional(),positionTitle:z.string().max(240),employer:z.string().max(260),current:z.boolean().optional(),startDate:z.string().max(80).optional(),endDate:z.string().max(80).optional(),location:z.string().max(260).optional(),city:z.string().max(120).optional(),region:z.string().max(120).optional(),country:z.string().max(120).optional(),responsibilities:z.array(z.string().max(1200)).max(60).default([]),reasonForLeaving:z.string().max(1000).optional()});
const educationRecord=z.object({id:z.string().optional(),degree:z.string().max(260),fieldOfStudy:z.string().max(260).optional(),institution:z.string().max(280),startDate:z.string().max(80).optional(),endDate:z.string().max(80).optional(),graduationDate:z.string().max(80).optional(),completed:z.boolean().optional(),location:z.string().max(240).optional()});
const certificationRecord=z.object({id:z.string().optional(),name:z.string().max(280),issuer:z.string().max(240).optional(),issuedAt:z.string().max(80).optional(),expiresAt:z.string().max(80).optional(),credentialId:z.string().max(180).optional()});
const languageRecord=z.object({id:z.string().optional(),language:z.string().max(120),proficiency:z.string().max(120).optional()});
const projectRecord=z.object({id:z.string().optional(),name:z.string().max(260),role:z.string().max(220).optional(),startDate:z.string().max(80).optional(),endDate:z.string().max(80).optional(),description:z.string().max(5000).optional()});
const volunteerRecord=z.object({id:z.string().optional(),organization:z.string().max(260),role:z.string().max(220).optional(),startDate:z.string().max(80).optional(),endDate:z.string().max(80).optional(),description:z.string().max(5000).optional()});
const awardRecord=z.object({id:z.string().optional(),title:z.string().max(280),issuer:z.string().max(240).optional(),date:z.string().max(80).optional(),description:z.string().max(4000).optional()});
const publicationRecord=z.object({id:z.string().optional(),title:z.string().max(320),publisher:z.string().max(260).optional(),date:z.string().max(80).optional(),url:z.string().max(500).optional(),description:z.string().max(4000).optional()});
const structuredResume=z.object({employmentHistory:z.array(employment).max(60).default([]),educationHistory:z.array(educationRecord).max(40).default([]),skills:z.array(z.string().max(180)).max(200).default([]),certifications:z.array(certificationRecord).max(60).default([]),languages:z.array(languageRecord).max(40).default([]),projects:z.array(projectRecord).max(50).default([]),volunteerExperience:z.array(volunteerRecord).max(50).default([]),awards:z.array(awardRecord).max(50).default([]),publications:z.array(publicationRecord).max(50).default([]),additionalInformation:z.string().max(20000).optional()});
const submission=z.object({firstName:z.string().trim().min(1).max(100),lastName:z.string().trim().min(1).max(100),email:z.string().email(),phone:z.string().max(50).optional(),location:z.string().max(160).optional(),linkedinUrl:z.string().max(500).optional(),portfolioUrl:z.string().max(500).optional(),githubUrl:z.string().max(500).optional(),socialMediaUrl:z.string().max(500).optional(),headline:z.string().max(240).optional(),summary:z.string().max(5000).optional(),professionalExperience:z.string().max(30000).optional(),skills:z.array(z.string().max(160)).max(200).default([]),certifications:z.array(z.string().max(300)).max(100).default([]),education:z.array(z.string().max(700)).max(100).default([]),languages:z.string().max(10000).optional(),projects:z.string().max(20000).optional(),volunteerExperience:z.string().max(20000).optional(),awards:z.string().max(10000).optional(),publications:z.string().max(15000).optional(),additionalInformation:z.string().max(20000).optional(),structuredResume:structuredResume.default({employmentHistory:[],educationHistory:[],skills:[],certifications:[],languages:[],projects:[],volunteerExperience:[],awards:[],publications:[]}),customResumeSections:z.array(customResumeSection).max(20).default([]),yearsOfExperience:z.number().min(0).max(80).optional(),screeningAnswers:z.record(z.string(),z.union([z.string(),z.number(),z.boolean()])).default({}),coverLetterText:z.string().max(100000).optional(),candidateStatement:z.string().max(5000).optional(),consent:z.literal(true),accuracyConfirmed:z.literal(true),talentPoolConsent:z.boolean().default(false)});
