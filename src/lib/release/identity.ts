...
export const OPSIQO_PRODUCT_RELEASE = process.env.OPSIQO_PRODUCT_RELEASE || '8.5-v7.32-H47';
export const OPSIQO_FEATURE_RELEASE = process.env.OPSIQO_FEATURE_RELEASE || 'H47';
export const OPSIQO_PATCH_RELEASE = process.env.OPSIQO_PATCH_RELEASE || 'H47.1F';
