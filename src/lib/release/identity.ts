...
export const OPSIQO_PATCH_RELEASE = process.env.OPSIQO_PATCH_RELEASE || 'H50.6K';
export const OPSIQO_UPGRADE_PARENT_PATCH = 'H50.6J';
export const OPSIQO_CERTIFIED_PATCH_LINEAGE = ['H50.6I','H50.6J'] as const;
