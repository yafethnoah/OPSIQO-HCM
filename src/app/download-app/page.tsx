...
export default function DownloadAppPage() {
  ...
  return <>
    <PageHeader title="Download OPSIQO Pulse" subtitle="Install the approved employee mobile app, then sign in with the same OPSIQO work account." />
    <div className="grid2">
      <section className="card stack">
        <h2 className="sectionTitle">Android</h2>
        <p className="muted">Install the approved OPSIQO Pulse Android build for your organization.</p>
      ...
      <section className="card stack">
        ...
        <p className="muted">Install OPSIQO Pulse from the approved Apple distribution channel (TestFlight during testing, App Store after release).</p>
