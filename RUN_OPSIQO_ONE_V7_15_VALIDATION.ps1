...
function Step([string]$Name,[scriptblock]$Action) {
  ...
  Write-Host " OPSIQO ONE V7.15 - $Name" -ForegroundColor Magenta
  Write-Host ('=' * 72) -ForegroundColor Magenta
  & $Action
...
Set-Location $Root
Write-Host 'OPSIQO ONE v7.15 local certification' -ForegroundColor Cyan
...
Step 'V7.15 Connected Workforce Operations audit' { npm run opsiqo85:opsiqo-one-v7.15:audit }
...
Write-Host ' OPSIQO ONE V7.15 CERTIFICATION PASS' -ForegroundColor Green
Write-Host ('=' * 72) -ForegroundColor Green
