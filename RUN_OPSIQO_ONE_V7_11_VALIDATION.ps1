...
function Step([string]$Name,[scriptblock]$Action) {
  ...
  Write-Host " OPSIQO ONE V7.11 - $Name" -ForegroundColor Magenta
  Write-Host ('=' * 72) -ForegroundColor Magenta
  & $Action
...
Write-Host 'OPSIQO ONE v7.11 local certification' -ForegroundColor Cyan
...
Step 'V7.11 architecture audit' { npm run opsiqo85:opsiqo-one-v7.11:audit }
...
Write-Host ' OPSIQO ONE V7.11 CERTIFICATION PASS' -ForegroundColor Green
Write-Host ('=' * 72) -ForegroundColor Green
