...
function Step([string]$Name,[scriptblock]$Action) {
  ...
  Write-Host " OPSIQO ONE V7.12 - $Name" -ForegroundColor Magenta
  Write-Host ('=' * 72) -ForegroundColor Magenta
  & $Action
...
Write-Host 'OPSIQO ONE v7.12 local certification' -ForegroundColor Cyan
...
Step 'V7.12 Talent/Scenario/Value architecture audit' { npm run opsiqo85:opsiqo-one-v7.12:audit }
Step 'V7.11 Cortex/Concierge/Governance regression' { npm run opsiqo85:opsiqo-one-v7.11:audit }
Step 'V7.10 foundation regression audit' { npm run opsiqo85:opsiqo-one-v7.10:audit }
...
Write-Host ' OPSIQO ONE V7.12 CERTIFICATION PASS' -ForegroundColor Green
Write-Host ('=' * 72) -ForegroundColor Green
