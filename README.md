# OPSIQO HCM 8.5 V7.9.3 consolidated recovery

> Includes the V7.9.2 certification/security repair and V7.9.3 UX + functional closure. See `START_HERE_V7_9_3.md`.

# OPSIQO HCM 8.5 V7.8 — Employee Self-Service Portal

V7.8 adds a dedicated `/employee` experience for employees to request vacation/leave, submit and track HR service requests, and reach their permitted personal HR services without gaining HR administrative access. See `EMPLOYEE_PORTAL_V7_8.md` for the employee experience and governance model.

# OPSIQO HCM 8.5 V7.7 Automation-Max

**Latest consolidated project:** safe/repeatable HR, workflow, integration, analytics, security and governance processors are unified into one observable automation cycle. Start with `START_HERE_V7_7.md` and review `AUTOMATION_V7_7.md`. Consequential employment decisions remain human-governed.
