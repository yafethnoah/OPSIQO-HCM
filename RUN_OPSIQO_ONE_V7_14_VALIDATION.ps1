...
function Step([string]$Name,[scriptblock]$Action) {
  ...
  Write-Host " OPSIQO ONE V7.14 - $Name" -ForegroundColor Magenta
  Write-Host ('=' * 72) -ForegroundColor Magenta
  & $Action
...
Set-Location $Root
Write-Host 'OPSIQO ONE v7.14 local certification' -ForegroundColor Cyan
...
Step 'V7.14 Launchpad/Adaptive/Mobile Intelligence audit' { npm run opsiqo85:opsiqo-one-v7.14:audit }
...
Write-Host ' OPSIQO ONE V7.14 CERTIFICATION PASS' -ForegroundColor Green
Write-Host ('=' * 72) -ForegroundColor Green
