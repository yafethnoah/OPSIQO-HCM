...
Write-Host 'OPSIQO 8.5 V7.9 ENTERPRISE SELF-SERVICE - immutable-source validation' -ForegroundColor Cyan
...
Run-Gate 'V7.9 Enterprise Self-Service tests' { npm run test:enterprise-self-service-v7.9 }
Run-Gate 'V7.8 Employee Portal tests' { npm run test:employee-portal-v7.8 }
...
Write-Host "`nPASS: OPSIQO 8.5 V7.9 ENTERPRISE SELF-SERVICE validation completed." -ForegroundColor Green
