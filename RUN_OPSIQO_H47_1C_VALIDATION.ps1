...
Write-Host 'OPSIQO H47.1C MOBILE TOOLCHAIN COMPATIBILITY VALIDATION' -ForegroundColor Magenta
...
try {
  if (-not (Test-Path '.\node_modules\.bin\tsc.cmd')) {
    Write-Host 'Installing isolated H47.1C mobile dependencies...' -ForegroundColor Cyan
...
Write-Host 'H47.1C OPSIQO EMPLOYEE MOBILE TOOLCHAIN COMPATIBILITY: PASS' -ForegroundColor Green
