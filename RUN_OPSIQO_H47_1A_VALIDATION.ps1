...
Write-Host 'OPSIQO H47.1A MOBILE CERTIFICATION REPAIR VALIDATION' -ForegroundColor Magenta
...
try {
  if (-not (Test-Path '.\node_modules\.bin\tsc.cmd')) {
    Write-Host 'Installing isolated H47.1A mobile dependencies...' -ForegroundColor Cyan
...
Write-Host 'H47.1A OPSIQO EMPLOYEE MOBILE CERTIFICATION REPAIR: PASS' -ForegroundColor Green
