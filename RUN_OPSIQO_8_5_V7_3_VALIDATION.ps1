...
Write-Host "OPSIQO V7.3 validates the signed dependency baseline before installation." -ForegroundColor Yellow
...
Write-Host "`nOPSIQO 8.5 V7.3 validation gates completed successfully." -ForegroundColor Green
