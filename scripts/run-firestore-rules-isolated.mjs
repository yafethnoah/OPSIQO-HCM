...
// Invoke the Firebase CLI JavaScript entry point directly with Node rather than
// spawning firebase.cmd through a shell. On Windows, shell parsing can split
// the emulators:exec script argument ("vitest run ...") into several arguments,
// which Firebase CLI rejects as "Too many arguments".
