...
add('resume-intake-ui',has('src/components/resume-intake-assistant.tsx','Candidate fields were prefilled','resume_parser_unavailable','Attach resume to prefill candidate','transient')&&has('src/components/recruiting-workspace.tsx','ResumeIntakeAssistant'),'Resume parser can prefill candidate intake before human submit');
...
add('jd-assistant-ui',has('src/components/job-description-assistant.tsx','export function JobDescriptionAssistant','requirements.length','Job description parsed. Prefilled the supported fields')&&has('src/components/recruiting-workspace.tsx','JobDescriptionAssistant'),'Job-description requirement assistant present');
